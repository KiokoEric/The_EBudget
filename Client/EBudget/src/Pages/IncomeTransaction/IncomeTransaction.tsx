...
const IncomeTransaction:React.FC = () => {
    ...
    // EDIT INCOME TRANSACTION FUNCTION
    ...
    return (
        <div className="w-screen">
            <figure className='flex justify-center gap-4 lg:justify-start'>
                <RiEditFill size="2.5rem" />
                <h1 className='font-bold pb-2 text-3xl sm:text-5xl'>Edit Income Transaction</h1>
            </figure>
            <hr />
