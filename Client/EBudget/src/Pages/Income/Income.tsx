...
return (
    <div className='flex flex-col gap-10 text-black w-11/12'>
        <Heading
            Heading='Income'
            HeadingStyle='font-bold text-center text-green-700 text-5xl'
        ...
        <section className='flex flex-col items-center mb-5 px-5'>
            <form method="post" onSubmit={handleSubmit(AddIncome)} encType="multipart/form-data" className='flex flex-col gap-8'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input type='date' className="border-black border-b h-6 outline-none px-1 py-2 w-96" {...register('Date', { required: 'Date is required' })} required ></input>
